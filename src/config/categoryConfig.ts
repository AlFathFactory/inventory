...
export const categoryConfig = {
  ...
  cutting_discs: {
    ...
    attributeFields: ['code', 'received_by', 'scrapped_date', 'notes'],
    createFields: [
      { key: 'code' },
      { key: 'type_name', required: true },
      { key: 'received_by', required: true },
      { key: 'received_date', inputType: 'date' },
      { key: 'scrapped_date', inputType: 'date' },
      { key: 'notes', inputType: 'textarea' },
    ],
    searchableFields: ['code', 'type_name', 'received_by', 'notes'],
  ...
  cylinders: {
    ...
    createFields: [
      ...
      { key: 'stock_balance', inputType: 'number' },
      { key: 'transaction_date', inputType: 'date', required: true },
    ...
    searchableFields: ['project', 'type_name', 'notes'],
    dateField: 'transaction_date',
  ...
  long_welding_gloves: {
    ...
    attributeFields: ['received_by', 'notes'],
    createFields: [
      { key: 'type_name', required: true },
      { key: 'received_by', required: true },
      { key: 'received_date', inputType: 'date', required: true },
      { key: 'notes', inputType: 'textarea' },
    ],
    searchableFields: ['type_name', 'received_by', 'notes'],
    dateField: 'received_date',
    itemNameField: 'type_name',
    operationsEnabled: false,
  },

...
import { getDashboardRowDetailsRoute } from '../items/itemRoutes'
...
export function LowStockPage() {
  ...
  const statusFilter = (searchParams.get('status') ?? 'all') as AlertStatusFilter
  ...
  const updateFilter = (name: string, value: string, defaultValue = '') => {
    setSearchParams((currentParams) => {
      const nextParams = new URLSearchParams(currentParams)
      if (value === defaultValue) nextParams.delete(name)
